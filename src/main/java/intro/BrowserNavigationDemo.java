...
public class BrowserNavigationDemo extends BaseTest{
    ...
    public void testNavigation(){
        // с помощью этой функции мы можем возвращатся назад или вперед в браузере
        ...
        // сравниваем url --getCurrentUrl()---> это фактический url
        driver.navigate().back(); // это кнопка назад в браузере
        Helper.pause(3000);
